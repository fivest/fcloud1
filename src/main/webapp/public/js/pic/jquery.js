(function (e, t) {
    ...
    b.event = {
        ...
        var n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, w = "", E = e.document, S = {}, x = 0, T = 0, N = it(), C = it(), k = it(), L = typeof t, A = 1 << 31, O = [], M = O.pop, _ = O.push, D = O.slice, P = O.indexOf || function (e) {
    ...
    }), e.jQuery = e.$ = b, typeof define == "function" && define.amd && define.amd.jQuery && define("public/js/pic/jquery.js", [], function (e, t, n) {
        try {
            return b;
        } catch (r) {
            wx.jslog({
                src: "public/js/pic/jquery.js"
            }, r);
        }
    });
})(window);
