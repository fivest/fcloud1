...
$.fn.themeswitcher = function(settings){
    var options = jQuery.extend({
        ...
        onSelect: function(){},
        useStandard:true,
        cssPrefix:"public/css/themes/",
		cssSuffix:"/jquery-ui.css",
		imgPrefix:"public/css/themesicon/theme_90_",
		imgSuffix:".png",
		imageLocation:"public/css/themesicon/",
        themes:{},
        useCookie:true
    }, settings);
    ...
    .find('li').hover(
        function(){
            $(this).css({
                'borderColor':'#555',
                'background': 'url('+options.imageLocation+'bg_thrd_hover.png) 50% 50% repeat-x',
                cursor: 'pointer'
            });
        },
        function(){
