...
<div id="optBarDiv">
	<kmss:auth requestURL="/weservice/we_user_log_link/weUserLogLink.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.edit"/>"
			onclick="Com_OpenWindow('weUserLogLink.do?method=edit&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/weservice/we_user_log_link/weUserLogLink.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.delete"/>"
			onclick="if(!confirmDelete())return;Com_OpenWindow('weUserLogLink.do?method=delete&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<input type="button"
