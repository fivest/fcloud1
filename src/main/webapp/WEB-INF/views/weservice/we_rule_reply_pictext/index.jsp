    ...
    <template:block name="body">
        ...
        <div data-role="header" data-theme="a">
            ...
            <div class="ui-btn-right">
                <a href="<%=request.getContextPath()%>/weservice/we_rule_reply_pictext/add?type=2" target="_blank">新增</a>
            </div>
        </div>
        <table class="movie-list ui-responsive">
            ...
            <c:forEach items="${page.content}" var="m">
                <tr>
                    ...
                    <td><a href="<%=request.getContextPath()%>/weservice/we_rule_reply_pictext/add?fdId=${m.id}&type=2" target="_blank">编辑</a>
                        <a href="<%=request.getContextPath()%>/weservice/we_rule_reply_pictext/${m.id}?_method=DELETE"
                           target="_blank">删除</a>
                    </td>
                </tr>
            </c:forEach>
