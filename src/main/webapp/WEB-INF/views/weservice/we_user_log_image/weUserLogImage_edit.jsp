...
<div id="optBarDiv">
	<c:if test="${weUserLogImageForm.method_GET=='edit'}">
		<input type=button value="<bean:message key="button.update"/>"
			onclick="Com_Submit(document.weUserLogImageForm, 'update');">
	</c:if>
	<c:if test="${weUserLogImageForm.method_GET=='add'}">
		<input type=button value="<bean:message key="button.save"/>"
			onclick="Com_Submit(document.weUserLogImageForm, 'save');">
		<input type=button value="<bean:message key="button.saveadd"/>"
			onclick="Com_Submit(document.weUserLogImageForm, 'saveadd');">
	</c:if>
